...
export default class Objects
{
    ...
    mergeGeometries = (geometries) => {
        ...
        geometries.forEach(geometry => {
            positionArray.push(...geometry.attributes.position.array);
            normalArray.push(...geometry.attributes.normal.array);
            if (geometry.attributes.uv) {
                uvArray.push(...geometry.attributes.uv.array);
            }
        });
    ...
    setMerge()
    {
        ...
        this.merge.applyMerge = () => {
            for (const _mergeItemName in this.merge.items) {
                ...
                // Replace this line with the custom merge function
                mergeItem.geometry = mergeGeometries(mergeItem.geometriesToMerge);
    ...
    add(_options)
    {
        ...
        if (_options.collision && _options.collision.children) {
