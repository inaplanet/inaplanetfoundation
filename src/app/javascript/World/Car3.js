...
export default class Car3
{
    ...
    setModels()
    {
        ...
        {
            this.models.chassis = this.resources.items.car3DefaultChassis
            this.models.antena = this.resources.items.car3DefaultAntena
            // this.models.bunnyEarLeft = this.resources.items.car3DefaultBunnyEarLeft
            // this.models.bunnyEarRight = this.resources.items.car3DefaultBunnyEarRight
            this.models.backLightsBrake = this.resources.items.car3DefaultBackLightsBrake
            this.models.backLightsReverse = this.resources.items.car3DefaultBackLightsReverse
            this.models.backLightsBattery = this.resources.items.carDefaultBackLightsBattery
            this.models.wheel = this.resources.items.car3DefaultWheel
        }
    }
    ...
    setChassis()
    {
        ...
        this.chassis.object.position.copy(this.physics.car3.chassis.body.position)
        ...
        this.time.on('tick', () =>
        {
            ...
            if(!this.transformControls.enabled)
                ...
                this.chassis.object.position.copy(this.physics.car3.chassis.body.position).add(this.chassis.offset)
                this.chassis.object.quaternion.copy(this.physics.car3.chassis.body.quaternion)
    ...
    setWheels()
    {
        ...
        this.time.on('tick', () =>
        {
            if(!this.transformControls.enabled)
                ...
                for(const _wheelKey in this.physics.car3.wheels.bodies)
                {
                    const wheelBody = this.physics.car3.wheels.bodies[_wheelKey]
        ...
        if (typeof window !== 'undefined') {
            ...
            window.addEventListener('keydown', (_event) =>
            {
                if(_event.key === 'b')
                {
                    ...
                    const car3Position = new CANNON.Vec3(this.position.x, this.position.y, this.position.z + 1)
                    let direction = car3Position.vsub(bowlingBall.collision.body.position)
                    direction.normalize()
