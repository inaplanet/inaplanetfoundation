...
export default class InformationSection
{
    ...
    setLinks()
    {
        ...
        this.links.options = [
            {
                href: 'https://twitter.com/panaceacl',
                labelTexture: this.resources.items.informationContactTwitterLabelTexture
            },
            {
                href: 'https://opensea.io/collection/panaceacryptolab/overview',
                labelTexture: this.resources.items.informationContactGithubLabelTexture
            },
            {
                href: 'https://etherscan.io/address/0x34d3213d92d66ee35183d1e303dbb8bbcd71b86f',
                labelTexture: this.resources.items.informationContactLinkedinLabelTexture
            },
            {
                href: 'https://etherscan.io/address/0xb71aacfc5ea13184fda7c64140f7a8e226917ba2',
