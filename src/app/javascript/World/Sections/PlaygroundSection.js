        ...
        this.brickWalls.items.push(
            ...
            this.walls.add({
                ...
                shape:
                {
                    ...
                    widthCount: 6,
                    heightCount: 12,
                    position: new THREE.Vector3(this.brickWalls.x - 14, this.brickWalls.y, 0),
                    offsetWidth: new THREE.Vector3(0, 1.05, 0),
                    offsetHeight: new THREE.Vector3(0, 0, 0.45),
                    randomOffset: new THREE.Vector3(0, 0, 0),
                    randomRotation: new THREE.Vector3(0, 0, 0.4)
            ...
            this.walls.add({
                ...
                shape:
                {
                    ...
                    widthCount: 7,
                    heightCount: 14,
                    position: new THREE.Vector3(this.brickWalls.x - 24, this.brickWalls.y, 0),
                    offsetWidth: new THREE.Vector3(0, 1.05, 0),
                    offsetHeight: new THREE.Vector3(0, 0, 0.45),
                    randomOffset: new THREE.Vector3(0, 0, 0),
                    randomRotation: new THREE.Vector3(0, 0, 0.4)
