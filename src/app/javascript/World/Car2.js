...
export default class Car2
{
    ...
    setModels()
    {
        ...
        {
            this.models.chassis = this.resources.items.car2DefaultChassis
            this.models.antena = this.resources.items.car2DefaultAntena
            this.models.backLightsBrake = this.resources.items.car2DefaultBackLightsBrake
            this.models.backLightsReverse = this.resources.items.car2DefaultBackLightsReverse
            this.models.backLightsBattery = this.resources.items.carDefaultBackLightsBattery
            this.models.wheel = this.resources.items.car2DefaultWheel
        }
    }
    ...
    setChassis()
    {
        ...
        this.chassis.object.position.copy(this.physics.car2.chassis.body.position)
        ...
        this.time.on('tick', () =>
        {
            ...
            if(!this.transformControls.enabled)
                ...
                this.chassis.object.position.copy(this.physics.car2.chassis.body.position).add(this.chassis.offset)
                this.chassis.object.quaternion.copy(this.physics.car2.chassis.body.quaternion)
    ...
    setWheels()
    {
        ...
        this.time.on('tick', () =>
        {
            if(!this.transformControls.enabled)
                ...
                for(const _wheelKey in this.physics.car2.wheels.bodies)
                {
                    const wheelBody = this.physics.car2.wheels.bodies[_wheelKey]
        ...
        if (typeof window !== 'undefined') {
            ...
            window.addEventListener('keydown', (_event) =>
            {
                if(_event.key === 'b')
                {
                    ...
                    const car2Position = new CANNON.Vec3(this.position.x, this.position.y, this.position.z + 1)
                    let direction = car2Position.vsub(bowlingBall.collision.body.position)
                    direction.normalize()
