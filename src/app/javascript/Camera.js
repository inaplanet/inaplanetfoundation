...
export default class Camera
{
    ...
    setOrthographic() {
        ...
        // Items
        this.angle.items = {
            default: new THREE.Vector3(20.135, - 1.45, 10.15),
            projects: new THREE.Vector3(4.38, - 1.4, 2.63)
        }
    ...
    setBirdsEye() {
        ...
        // Items
        this.angle.items = {
            default: new THREE.Vector3(1.135, - 1.45, 100.15),
            projects: new THREE.Vector3(1.38, - 1.4, 10.63)
        }
    ...
    setAngle()
    {
        ...
        // Items
        this.angle.items = {
            default: new THREE.Vector3(0.135, - 1.45, 1.15),
            projects: new THREE.Vector3(0.38, - 1.4, 1.63)
        }
